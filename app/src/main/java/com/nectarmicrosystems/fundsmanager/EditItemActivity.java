...
public class EditItemActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setContentView(R.layout.edit_item_activity_layout);

        tabHost = (TabHost)findViewById(R.id.editSingleItemTabHost);
        nameField = (EditText)findViewById(R.id.editSingleItemName);
        amountField = (EditText)findViewById(R.id.editSingleItemAmount);
        descriptionField = (EditText)findViewById(R.id.editSingleItemDescription);
        addButton = (Button)findViewById(R.id.editSingleItemBtn);
        dateField = (EditText)findViewById(R.id.editSingleItemInputDate);
        dateField.setInputType(InputType.TYPE_NULL);

        dateField.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new DatePickerDialog(EditItemActivity.this, date, calendar.get(Calendar.YEAR), calendar.get(Calendar.MONTH), calendar.get(Calendar.DAY_OF_MONTH)).show();
            }
        });
        ...
        addButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ExpenseItem entry = new ExpenseItem(EditItemActivity.this);
                try {
                    entry.open();
                    ...
                    Intent i = new Intent(EditItemActivity.this, LaunchActivity.class);
                    startActivity(i);
                    overridePendingTransition(0, 0);

                    Intent i1 = new Intent(EditItemActivity.this, SingleItemDetailsActivity.class);
